    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-900 via-zinc-900 to-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute bottom-20 left-1/3 w-72 h-72 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
        </div>
              ...
              <GlassmorphicCard>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="space-y-1">
                    ...
                    <div className="font-medium">Gustavo Garcia da Hora</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-sm text-zinc-500">Email</div>
                    <div className="font-medium">gustadahora68@gmail.com</div>
                  </div>
                  <div className="space-y-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">github.com/GustaDaHora</div>
                  </div>
                </div>
              </div>
